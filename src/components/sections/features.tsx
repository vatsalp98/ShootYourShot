    ...
    <div>
      <section className="border-t-2 border-t-border bg-bg py-20 font-base dark:border-t-darkBorder dark:bg-darkBg lg:py-[100px]">
        <h2 className="mb-14 px-5 text-center text-2xl font-heading md:text-3xl lg:mb-20 lg:text-4xl">
          Discover and Connect: Tailored Dating Features for Every Love Story
        </h2>
        ...
        <div className="w-container mx-auto grid max-w-full grid-cols-1 gap-5 px-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => {
            ...
            return (
              <div
                className="flex flex-col gap-3 rounded-base border-2 border-border bg-white p-5 shadow-light dark:border-darkBorder dark:bg-darkBg dark:shadow-dark"
                key={i}
              >
                <Icon />
